...
{
    public function tambahdetailobat(Request $request ){
    ...
    $detailPembelian->jenis = 'obat';
        $detailPembelian->id_pembelian = 1;
        $detailPembelian->status = 'menunggu P.gudang';
    ...
    return redirect()->route('admin_beli_obat');
        
        
    }
    public function tambahdetailbahan(Request $request ){
        // Validasi data yang diterima
    $validatedData = $request->validate([
        'id_obat' => 'required',
        'nama_obat' => 'required',
    ...
    public function tambahdetailalat(Request $request ){
