...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card beli_obat">
        ...
        <div class="dua_input">
          ...
          <input id="tanggal_pembelian" type="text" name="tanggal" class="form-control" aria-describedby="defaultFormControlHelp" />
        </div>
        <div class="dua_label" >
        ...
        <div class="dua_input">
          <input id="jam" type="text" value="" class="form-control" name="jam" placeholder="Masukkan Jam" aria-describedby="defaultFormControlHelp" />
        ...
        <a class="dua_obat"><button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahobat">Buat Transaksi</button></a>
      </form>
    </div>
</div>
...
<div class="modal fade" id="masukkansubtotal" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none;" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="/admin/detail_pembelian/tambah" method="POST">
      @csrf
